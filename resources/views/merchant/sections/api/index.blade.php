                    ...
                    <div class="col-lg-12">
                        <div class="dash-payment-item-wrapper">
                            <div class="dash-payment-item active">
                                <div class="dash-payment-title-area justify-content-between align-items-center">
                                    ...
                                    <button type="button" class="btn--base bg--warning active-deactive-btn">{{ __("Go To Production") }}</button>
                                    @else
                                        <button type="button" class="btn--base active-deactive-btn">{{ __("Go To Sandbox") }}</button>
                                    @endif
                                </div>
                                <div class="card-body">
...
@push('script')
    <script>
        ...
        $('.copy-primary').on('click',function(){
                ...
                throwMessage('success',["Copied Client ID"]);
        });
        //Secret  key copy
        $('.copy-secret').on('click',function(){
                ...
                copyText.setSelectionRange(0, 99999);
                document.execCommand("copy");
                throwMessage('success',["Copied Secret ID"]);
        });
    </script>
@endpush
