...
<div class="developer-body-wrapper">
    <div class="developer-main-wrapper">
        ...
        <p>{{ __("Thank you for choosing ". @$basic_settings->site_name. " Payment Gateway Solutions! We look forward to seeing your integration thrive and provide a seamless payment experience for your valued customers.") }}</p>
    </div>
