...
<div class="developer-body-wrapper">
    <div class="developer-main-wrapper">
        ...
        <p>To access the {{ __(@$basic_settings->site_name) }} Developer API, you’ll need an API key. You can obtain your API key by logging in to your {{ __(@$basic_settings->site_name) }} merchant account and navigating to the API section. Collect <strong class="fst-italic">Client/Primary Key</strong> & <strong class="fst-italic">Secret Key</strong> Carefully. Keep your API key confidential and do not share it publicly.</p>
