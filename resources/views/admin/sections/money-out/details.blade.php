        ...
        <form class="card-form">
            ...
            <div class="row ">
                <div class="col-md-6 offset-md-3 ">
                    <div class="one sent_to_number text-center">Sent To Number: <span>{{ $data->sent_to_number }}</span></div>
                </div>
            </div>
                    ...
                    <div class="row mb-10-none">
                        <div class="col-xl-12 col-lg-12 form-group">
                           ...
                           <div class="form-group mb-3">
                            <label for="sent_to_number">Sent to number</label>
                            <input type="text" name="sent_to_number" class="form-control" placeholder="017xxxxxxx" required>
                           </div>
                        </div>
                    </div>
