...
class RegisterController extends Controller
{
    ...
    */
    ...
    public function sendVerifyCode(Request $request){
        ...
        return redirect()->route('merchant.email.verify',$data['token'])->with(['success' => ['Verification code send to your email successfully!']]);
    }
    ...
    public function resendCode(Request $request){
        ...
        return redirect()->route('merchant.email.verify',$data['token'])->with(['success' => ['Verification code resend success!']]);
    }
